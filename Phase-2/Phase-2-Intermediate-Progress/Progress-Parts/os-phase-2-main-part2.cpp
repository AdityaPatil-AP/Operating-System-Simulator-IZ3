...
{
    // TI AND SI
    cout << "TI is : " << TI << " SI is : " << SI << " PI is : " << PI << endl;
    if (TI == 0 && SI == 1)
    {
        read(address);
    }
...
void cpu ::executeUserProgram()
{
    ...
    while ((PI == 0) && (TI == 0))
    {
        ...
        cout << "RA is " << RA << " PI is : " << PI << endl;
        memcpy(IR, m[RA], 4);
        cout << "IR is exe is : " << IR << endl;
        IC++;
